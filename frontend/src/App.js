              ...
              {isAuthenticated && wallet && (
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 my-6">
                  ...
                  <div className="bg-gradient-to-br from-gray-600/20 to-gray-600/10 rounded-xl p-4 border border-gray-600/30 text-center">
                    ...
                    <div className="text-xs text-gray-400">Legacy ARACoins</div>
                  </div>
                </div>
              )}
      ...
      case 'explore':
        return (
          <div className="space-y-6">
            ...
            {/* Quickies Section - Coming Soon */}
            <div className="space-y-6">
              {/* Header Section */}
              <div className="text-center">
                <h3 className="text-3xl font-bold bg-gradient-to-r from-neon-orange via-neon-purple to-neon-green bg-clip-text text-transparent mb-4">
                  ✨ Quickies
                </h3>
              ...
              <div className="bg-gradient-to-br from-gray-900 via-black to-gray-900 rounded-2xl p-8 border-2 border-neon-purple/30 relative overflow-hidden">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <p className="text-lg text-gray-300 mb-6 max-w-2xl mx-auto">
                    ...
                    Think quick entertainment meets earning rewards - but better!
                  </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-8">
                    <div className="bg-gradient-to-br from-neon-orange/20 to-neon-orange/10 rounded-xl p-6 border border-neon-orange/30">
                      ...
                      <h5 className="text-neon-orange font-bold mb-2">15-60 Second Videos</h5>
                      <p className="text-gray-400 text-sm">Quick, engaging content optimized for mobile viewing</p>
                    </div>
                    
                    <div className="bg-gradient-to-br from-neon-purple/20 to-neon-purple/10 rounded-xl p-6 border border-neon-purple/30">
                      <div className="text-3xl mb-3">💰</div>
                      <h5 className="text-neon-purple font-bold mb-2">Enhanced Earning</h5>
                      <p className="text-gray-400 text-sm">Earn more ARACoins with our new quick-watch bonus system</p>
                    </div>
                    
                    <div className="bg-gradient-to-br from-neon-green/20 to-neon-green/10 rounded-xl p-6 border border-neon-green/30">
                      <div className="text-3xl mb-3">🎨</div>
                      <h5 className="text-neon-green font-bold mb-2">Creative Tools</h5>
              ...
              <div className="space-y-4">
                <h4 className="text-xl font-bold text-white text-center">Sneak Peek</h4>
